	...
	<BODY>
		<form name='form_login' method='post' target='operaciones' > <!-- action="modelos/controlador/admin_session.php" -->
			...
			<table border="0" align="center" width='90%' cellpadding="0" cellspacing="0">
				...
				<br>
			<div class="texto">
					SESPA es un sistema de informacion  que permite crear y manejar 
					sistematicamente registros historiales de animales 
					que padescan sintomas de una posible enfermedad y necesiten de una consulta veterinaria.<br><br>
					SESPA facilita al usuario el proceso de realizar historiales a los animales.
			</div><br><br><br><br>

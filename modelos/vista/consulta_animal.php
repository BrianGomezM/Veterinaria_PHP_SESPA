...
<html>
   <head>
	...
	<body>
		<form name='form_bus' method='post' target='IfrConsulta' action="../controlador/ctrl_consulta_animal.php">
		<!--<form target="operaciones" method="post">-->
			<input type="hidden" name="action" id="action" >
			<input type="hidden" name="id_tipo_busqueda" id="id_tipo_busqueda" >
			<table width="70%" border="0" height='10' align="center" class="buscar" cellpadding="0" cellspacing="0" valign='top' >
				<tr>

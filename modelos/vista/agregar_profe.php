						...
						function Registrar(register_form,aux)
							{
								...
								if(document.register_form.nombre.value=='')
									{
...
<div id="ventana1"></div>	
					<div id="register-div">
					<form  name="register_form" method="post" target="operaciones" action="../controlador/ctrl_ing_profesion.php">
					<input type="hidden" id="action" name="action" >
					
							<fieldset id="fiel"><legend id="regis" align="center">PROFESION</legend> 
					<input type="hidden" id="id" name="id" >
					<label>
								Nombre:<br>
							<input type="text" name="nombre" id="nombre" title="Digite El Nombre De La Profesion" size="55%"/>  
						<span></span>
					</label>
						<label>
			<!--<input type="button" onclick="validar(this.form)" value="Grabar usuario" class="boton">-->
			
				<input type="button" id="btn_regis" style="cursor:pointer;" name="btn_regis" value="Grabar Sintoma"  Onclick="Registrar(this.form,'reg')" >
				...
				<input type="button" id="btn_query" style="cursor:pointer;" name="btn_query" value="Consultar"  Onclick="ventana1('consulta_profesion.php',800, 400, 'CONSULTAR PROFESIONES');return false;" >
  </fieldset>  

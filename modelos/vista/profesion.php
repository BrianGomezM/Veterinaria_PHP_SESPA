...
<div id="ventana1"></div>	
			...
			<!--<input type="button" onclick="validar(this.form)" value="Grabar usuario" class="boton">-->
				...
				<input type="button" style="cursor:pointer" id="btn_regis" name="btn_regis" value="Guardar datos"  Onclick="Registrar(this.form,'reg')" >
				...
				<input type="button" style="cursor:pointer" id="btn_query" name="btn_query" value="Consultar"  Onclick="ventana1('consulta_profesion.php', 800, 400, 'CONSULTAR PROFESIONES');return false;" >
  </fieldset>  

...
<html>
   <head>
	...
	<body>
		<form name='form_bus' method='post' target='IfrConsulta' action="../controlador/ctrl_consulta_usu.php">
		<!--<form target="operaciones" method="post">-->
			<input type="hidden" name="action" id="action" >
			<input type="hidden" name="id_tipo_busqueda" id="id_tipo_busqueda" >
			<table width="70%" border="0" height='10' align="center" cellpadding="0" cellspacing="0" valign='top' class="buscar" >
				<tr>
					...
					<td width="10%"  >
						<input type="button" id="btn_actu" title="Buscar usuario" class="boton1" name="btn_actu" value="Buscar" Onclick="buscar(this.form,'busc')">
					</td>
			</table>

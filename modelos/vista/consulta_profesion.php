...
<html>
   <head>
	...
	<body>
		<form name='form_bus' method='post' target='IfrConsulta' action="../controlador/ctrl_consulta_profesion.php">
		<!--<form target="operaciones" method="post">-->
			<input type="hidden" name="action" id="action" >
			<input type="hidden" name="id_tipo_busqueda" id="id_tipo_busqueda" >
			<table width="70%" border="0" class="buscar" height='10' align="center" cellpadding="0" cellspacing="0" valign='top' >
				<tr>

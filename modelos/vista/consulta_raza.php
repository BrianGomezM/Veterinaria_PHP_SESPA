...
<html>
   <head>
	...
	<body>
		<form name='form_bus' method='post' target='IfrConsulta' action="../controlador/ctrl_consulta_raza.php">
		<!--<form target="operaciones" method="post">-->
			<input type="hidden" name="action" id="action" >
			<input type="hidden" name="id_tipo_busqueda" id="id_tipo_busqueda" >
			<table width="70%" class="buscar" border="0" height='10' align="center" cellpadding="0" cellspacing="0" valign='top' >
				<tr>
					...
					<td width="10%"  >
						<input type="button" id="btn_actu" name="btn_actu" class="boton1" value="Buscar" Onclick="buscar(this.form,'busc')">
					</td>
			</table>

...
<html>
   <head>
	...
	<body>
		<form name='form_bus' method='post' target='IfrConsulta' action="../controlador/ctrl_consulta_propie.php">
		<!--<form target="operaciones" method="post">-->
			<input type="hidden" name="action" id="action" >
			<input type="hidden" name="id_tipo_busqueda" id="id_tipo_busqueda" >
			<table class="buscar" width="70%" border="0" height='10' align="center" cellpadding="0" cellspacing="0" valign='top' >
				<tr>
					...
					<td width="10%"  >
						<input type="button" style="cursor:pointer;" class="boton1" id="btn_actu" name="btn_actu" value="Buscar" Onclick="buscar(this.form,'busc')">
					</td>
			</table>
			<table width="100%" height='190' border="0" align="center" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<iframe name='IfrConsulta' width='99%' height='250' align='center' frameborder='1' src='../../include/blanco.html'></iframe>
					</td>
				</tr>
			</table>
			</form>

						...
						function Registrar(register_form,aux)
							{
								...
								if(document.register_form.alerg.value=='')
									{
										alert("Falta digitar la ALERGIA");
									}
		...
		<div id="ventana1">
			...
			<table border="0" align="center" width='90%' cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<div id="register-div">
					<form  name="register_form" method="post" target="operaciones" action="../controlador/ctrl_ing_alerg.php">
					<input type="hidden" id="action" name="action" >
					
							<fieldset id="fiel"><legend id="regis" align="center">Alergia</legend> 
								<input type="hidden" id="id" name="id" >
					<label>
								Nombre:<br>
							<input type="text" name="alerg" id="alerg" title="Digite el nombre de alergia"/>  
						<span></span>
					</label>
					<label>
								Sintoma:<br>
			...
			<!--<input type="button" onclick="validar(this.form)" value="Grabar usuario" class="boton">-->
				...
				<input type="button" id="btn_query" name="btn_query" value="Consultar"  Onclick="ventana1('consulta_alergia.php', 1000, 400, 'CONSULTAR ALERGIAS');return false;" >
  </fieldset>  

...
$sql="SELECT
		...
		FROM
		  ...
		  INNER JOIN listado_prueb_especifi ON listado_prueb_especifi.id_list_prueb_especif =
			prueba_especifica.id_list_prueb_especif WHERE animal.id_pac = '$var_dato_id' ";
...
$pdf ->Cell(200,10,"PRUEBAS ESPECIFICAS",0,0,'C');
$pdf -> Ln(10);
$pdf->Ln();
...
$pdf->SetFont('Arial','B',12);
$pdf->SetTextColor(89,181,72);
$pdf->Cell(40,7,"PRUEBAS ESPECIFICAS",0,0,'J');
$pdf->Ln();
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(89,181,72);

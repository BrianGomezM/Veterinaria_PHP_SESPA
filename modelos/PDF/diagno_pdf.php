...
INNER JOIN historial ON animal.id_pac = historial.id_pac WHERE animal.id_pac = '$var_dato_id' ";
...
$pdf ->Cell(200,10,"DIAGNOSTICOS Y PRONOSTICO",0,0,'C');
$pdf -> Ln(10);
$pdf->Ln();
...
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(35,130,118);
$pdf->Cell(50,7,'DIANOSTICO INSTAURADO:',0,0,'J');
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(35,130,118);
$pdf->Cell(50,7,'DIANOSTICO DIFERENCIAL:',0,0,'J');
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(35,130,118);
$pdf->Cell(50,7,'DIANOSTICO PRESUNTIVO:',0,0,'J');
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0,0,0);
...
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(35,130,118);
$pdf->Cell(50,7,'PRONOSTICO:',0,0,'J');
$pdf->SetFont('Arial','',10);
$pdf->SetTextColor(0,0,0);

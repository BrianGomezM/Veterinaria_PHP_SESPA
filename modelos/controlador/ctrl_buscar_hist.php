<?php
	...
	if($var_estado_bus==4){  $var_sql_01=""; }
		$sql="SELECT   id_pac, nomb_pac, color_pac,
						...
						alzada_pac, genero, id_usu, id_raza
			FROM animal $var_sql_01";
	
		//echo "<br>SQL: $sql";
		echo"<font size='1' face='arial,verdana' color='black' ><table width='100%' border='0' align='center' cellpadding='0' cellspacing='0'>
		...
		while($row=mysql_fetch_array($res))
				...
				echo "<tr>";
					echo "<th  bgcolor='#F2F8F8'><input type='radio' name='sele' id='sele' 
					...
					parent.parent.document.register_form.propie.value='".$row[id_usu]."';
					parent.parent.document.register_form.especie.value='".$row[id_raza]."';

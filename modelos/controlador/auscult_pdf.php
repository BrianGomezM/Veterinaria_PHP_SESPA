...
auscultacion.id_list_auscultacion WHERE animal.id_pac = '$var_dato_id' ";
...
$pdf ->Cell(200,10,"AUSCULTACION",0,0,'C');
$pdf -> Ln(10);
$pdf->Ln();
...
$pdf->SetFont('Arial','B',12);
$pdf->SetTextColor(89,181,72);
$pdf->Cell(40,7,"AUSCULTACION",0,0,'J');
$pdf->Ln();
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(89,181,72);
...
$pdf->SetFont('Arial','B',10);
$pdf->SetTextColor(89,181,72);
$pdf->Cell(100,7,'COMENTARIOaaaaaaaaaaaa',1,0,'J');
